  ...
  return (
    <div className="main-content fade-in">
      <div className="page-header">
        <h1>Your Profile</h1>
        <p>Manage your skills, interests, and availability to improve AI matching</p>
      </div>
          ...
          <form onSubmit={handleSave}>
              ...
              <div className="flex gap-2" style={{ flexWrap: 'wrap' }}>
                {SKILL_OPTIONS.map((s) => (
                  <button
                    ...
                    style={{
                      cursor: 'pointer',
                      background: form.skills.includes(s) ? 'rgba(139,92,246,0.25)' : 'rgba(139,92,246,0.06)',
                      border: form.skills.includes(s) ? '1px solid rgba(139,92,246,0.5)' : '1px solid rgba(139,92,246,0.15)',
                      fontSize: '0.78rem',
                      padding: '5px 12px',
                    }}
                  >
              ...
              <div className="flex gap-2" style={{ flexWrap: 'wrap' }}>
                {INTEREST_OPTIONS.map((i) => (
                  <button
                    ...
                    style={{
                      cursor: 'pointer',
                      background: form.interests.includes(i) ? 'rgba(6,182,212,0.25)' : 'rgba(6,182,212,0.06)',
                      border: form.interests.includes(i) ? '1px solid rgba(6,182,212,0.5)' : '1px solid rgba(6,182,212,0.15)',
                      color: 'var(--accent-1)',
                      fontSize: '0.78rem',
                      padding: '5px 12px',
                    }}
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
              <div className="form-group">
                ...
                <input id="profile-lat" className="form-control" type="number" step="any"
              ...
              <div className="form-group">
                ...
                <input id="profile-lng" className="form-control" type="number" step="any"
            ...
            <div className="flex items-center gap-3 mt-4">
              ...
              {saved && (
                <span style={{ color: 'var(--accent-4)', fontSize: '0.85rem', fontWeight: 500 }}>
                  ✅ Profile updated!
                </span>
              )}
            </div>
